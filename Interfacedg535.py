...
def mistery_box():
    urls =[ "https://www.youtube.com/watch?v=SimMH3Q6zLw","https://www.youtube.com/watch?v=IP11jDHwX98"]
...
def show_help():
    ...
    help_message = (
        ...
        "1. Start: Enter an initial frequency and press Start to activate the pulse generator, default is 50 Hz.\n"
...
help_menu.add_command(label = "I'm getting bored", command = mistery_box)
